...
ROWS = [
    ...
    ("kv", "Name", "Deepak S"),
    ("kv", "GitHub", "dpak-07"),
    ("kv", "Now", "Backend & Cloud Engineer · AI/ML Developer"),
    ("kv", "Focus", "CIVISENSE · Cloud Systems · Scalable APIs"),
    ("kv", "Work", "Live college website + exam portal on AWS"),
    ("kv", "Edu", "Final-year AI & Data Science student"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "Python · Node.js · Express · REST APIs"),
    ("kv", "Frontend", "React · Tailwind · Vite"),
    ("kv", "AI / ML", "PyTorch · CNN · YOLOv8 · Flask"),
    ("kv", "Cloud", "AWS EC2 · S3 · GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built production systems for 300+ concurrent users"),
    ("bul", "Exploring GATE (DA) / M.Tech and placement prep"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">dpak-07@github: ~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">dpak</tspan><tspan fill="{MUTED}">-07</tspan>'
